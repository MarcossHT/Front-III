import { Store } from '../../components/Store/earlyGames';
import { StoreCheap } from '../../components/Store/cheapGames'
import './style.scss';
...
export function DHGames() {
    ...
    return (
        <div className="dhStore-component">
            <h1 className="main-title">New Games</h1>
            <ul className="components-games">
                {
                    newGames.map(g => {
                        return (
                            <Store 
